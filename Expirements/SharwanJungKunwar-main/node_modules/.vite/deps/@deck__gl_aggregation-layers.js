import {
  ...
  project32_default,
  viewport_default
} from "./chunk-3MXR4LDC.js";
import "./chunk-GMQPJRV3.js";
import {
  __commonJS,
  __toESM
...
var uniformBlock5 = `uniform arcUniforms {
  bool greatCircle;
...
var uniformBlock6 = `uniform bitmapUniforms {
  vec4 bounds;
...
var uniformBlock7 = `uniform iconUniforms {
  float sizeScale;
...
var uniformBlock8 = `uniform columnUniforms {
  float radius;
  float angle;
  vec2 offset;
  bool extruded;
...
var uniformBlock9 = `uniform pathUniforms {
  float widthScale;
  float widthMinPixels;
  float widthMaxPixels;
  float jointType;
...
var uniformBlock10 = `uniform solidPolygonUniforms {
  bool extruded;
  bool isWireframe;
  float elevationScale;
} solidPolygon;
...
var uniformBlock11 = `uniform sdfUniforms {
  float gamma;
  bool enabled;
  float buffer;
  float outlineBuffer;
...
var uniformBlock12 = `uniform textBackgroundUniforms {
  bool billboard;
  float sizeScale;
  float sizeMinPixels;
  float sizeMaxPixels;
...
HexagonLayer.defaultProps = defaultProps17;
...
GridLayer.defaultProps = defaultProps18;
...
var GridCellLayer2 = class extends column_layer_default {
  getShaders() {
    const shaders = super.getShaders();
...
GridLayer2.defaultProps = defaultProps19;
...
var uniformBlock18 = `uniform triangleUniforms {
...
var uniformBlock19 = `uniform weightUniforms {
  vec4 commonBounds;
  float radiusPixels;
  float textureWidth;
  float weightsScale;
...
HeatmapLayer.defaultProps = defaultProps20;
