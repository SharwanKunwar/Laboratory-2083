...
function camelCase(input) {
  return input.replace(/-(.)/g, (match3, g) => g.toUpperCase());
}
...
function generate2(node2, key, rootProps) {
  if (!rootProps) {
    return import_react2.default.createElement(node2.tag, {
      key,
      ...normalizeAttrs(node2.attrs)
    }, (node2.children || []).map((child, index) => generate2(child, `${key}-${node2.tag}-${index}`)));
  }
  return import_react2.default.createElement(node2.tag, {
    key,
    ...normalizeAttrs(node2.attrs),
...
var CloseOutlined2 = (props, ref) => React4.createElement(AntdIcon_default, _extends2({}, props, {
  ref,
...
function useEvent(callback) {
  const fnRef = React5.useRef(callback);
  fnRef.current = callback;
  const memoFn = React5.useCallback((...args) => fnRef.current?.(...args), []);
  return memoFn;
}
...
var useSafeState = (defaultValue) => {
  const destroyRef = React7.useRef(false);
...
function useControlledState(defaultStateValue, value) {
  const [innerValue, setInnerValue] = (0, import_react3.useState)(defaultStateValue);
...
function isReactElement(node2) {
  return (0, import_react4.isValidElement)(node2) && !isFragment(node2);
}
var supportNodeRef = (node2) => {
  return isReactElement(node2) && supportRef(node2);
};
var getNodeRef = (node2) => {
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React12.useMemo(() => ({
    ...locale5,
    exist: true
  }), [locale5]);
...
var computeCloseIcon = (mergedConfig, fallbackCloseCollection, closeLabel) => {
  ...
  if (isNonNullable_default(finalCloseIcon)) {
    ...
    finalCloseIcon = import_react7.default.isValidElement(finalCloseIcon) ? import_react7.default.cloneElement(finalCloseIcon, {
...
var computeClosable = (propCloseCollection, contextCloseCollection, fallbackCloseCollection = EmptyFallbackCloseCollection, closeLabel = "Close") => {
  ...
  const mergedFallback = {
    closeIcon: import_react7.default.createElement(CloseOutlined_default2, null),
    ...fallbackCloseCollection
  };
...
var useForceUpdate = () => {
  return import_react8.default.useReducer((ori) => ori + 1, 0);
};
...
var useSemanticClassNames = (schema, ...classNames) => {
  return React15.useMemo(() => mergeClassNames.apply(void 0, [schema].concat(classNames)), [schema].concat(classNames));
};
...
var useSemanticStyles = (...styles) => {
  return React15.useMemo(() => mergeStyles.apply(void 0, styles), [].concat(styles));
};
...
var usePatchElement = () => {
  const [elements, setElements] = React16.useState([]);
  const patchElement = React16.useCallback((element) => {
...
var useProxyImperativeHandle = (ref, init) => {
  return (0, import_react12.useImperativeHandle)(ref, () => {
    const refObj = init();
    const {
      nativeElement
    } = refObj;
...
var useSyncState = (initialValue) => {
  const ref = React17.useRef(initialValue);
...
function useCacheToken(theme, tokens, option) {
  const {
    ...
    container,
    hashPriority
  } = (0, import_react14.useContext)(StyleContext_default);
  const {
    salt = "",
  ...
  const cachedToken = useGlobalCache(TOKEN_PREFIX, [salt, theme.id, tokenStr, overrideTokenStr, cssVarStr], () => {
    ...
    const style = updateCSS(cssVarsStr, hash_browser_esm_default(`css-var-${themeKey}`), {
      mark: ATTR_MARK,
      prepend: "queue",
      attachTo: container,
      priority: -999
...
function useStyleRegister(info, styleFn) {
  ...
  const {
    ...
    layer: enableLayer,
    autoPrefix
  } = React20.useContext(StyleContext_default);
...
var useCSSVarRegister = (config, fn) => {
  ...
  const {
    ...
    container,
    hashPriority
  } = (0, import_react15.useContext)(StyleContext_default);
  const {
    _tokenKey: tokenKey
  } = token2;
...
function useToken() {
  const {
    ...
    cssVar: ctxCssVar,
    zeroRuntime
  } = import_react17.default.useContext(DesignTokenContext);
  const cssVar = {
...
var style_default = genStyleHooks("Badge", (token2) => {
...
var Ribbon = (props) => {
  ...
  }, children, React27.createElement("div", {
  ...
  }, text), React27.createElement("div", {
...
//# sourceMappingURL=chunk-4UMB2ALG.js.map
